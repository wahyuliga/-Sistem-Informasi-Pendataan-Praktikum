        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_GET['nim'])) {
                        $table_name = 'asisten';
                        $data = mysqli_query($conn,"SELECT * FROM $table_name WHERE NIM='".$_GET['nim']."'");
                    }

                    $d = mysqli_fetch_array($data)
                    ?>
                    <!-- Form Edit -->
                    <form method="POST" action="proses_update_asisten.php">
                        <table class="table table-borderless">
                            <tr>			
                                <td><label>Nama</label></td>
                                <td>
                                    <input type="hidden" name="nim" value="<?php echo $_GET['nim']; ?>">
                                    <input type="text" class="form-control" name="nama" value="<?php echo $d['nama_asisten']; ?>">
                                </td>
                            </tr>
                            <tr>
                                <td><label>Modul</label></td>
                                <td>
                                <select class="form-control" name="modul_id">
                                    ...
                                    $sql = 'SELECT modul_id, nama_modul
                                        FROM `' . $table_name . '`';
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        if($d['modul_id'] == $row['modul_id']){
                                            $selected = "selected";
                                        } else{
                                            $selected = "";
                                        }
                                        echo '<option value="'.$row['modul_id'].'" '.$selected.'>'.$row['nama_modul'].'</option>';
                                    }  
                                    ?>
                                </select>
                                </td>
