...
<?php
    ...
    } elseif($_SESSION['role']=="praktikan"){
        die('<center><h1>403 Forbidden</h1></center><hr>');
    }
?>
<head>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ubah Data Modul</h1>
                    </div>
                    ...
                    if (isset($_GET['modul_id'])) {
                        $table_name = 'modul';
                        $data = mysqli_query($conn,"SELECT * FROM $table_name WHERE modul_id='".$_GET['modul_id']."'");
                    }
                    ...
                    <form method="POST" action="proses_update_data.php">
                        <table class="table table-borderless">
                            <tr>			
                                ...
                                <td>
                                    <input type="hidden" name="modul_id" value="<?php echo $_GET['modul_id']; ?>">
                                    <input type="text" class="form-control" name="nama" value="<?php echo $d['nama_modul']; ?>">
                                </td>
                            </tr>
                            <tr>
                                <td><label>Waktu</label></td>
                                <td><input type="text" class="form-control" name="param" value="<?php echo $d['modul_date']; ?>"></td>
                            </tr>
                            <tr>
                                ...
                                <select class="form-control" name="matkul">
                                    ...
                                    $table_name = 'matkulpraktikum';

                                    $sql = 'SELECT kode_matkul, nama_matkul
                                        FROM `' . $table_name . '` ';
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        if($d['kode_matkul'] == $row['kode_matkul']){
                                            $selected = "selected";
                                        } else{
                                            $selected = "";
                                        }
                                        echo '<option value="'.$row['kode_matkul'].'" '.$selected.'>'.$row['nama_matkul'].'</option>';
                                    }  
                                    ?>
                                </select>
                                </td>
